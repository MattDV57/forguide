...
def send_gmail_notification(job_id,  job, status, notify_users, workflow_url):
    ...
    admin_credentials = delegated_credential(credentials, "drive-transfer-service@themicrolab.joonix.net", SCOPES)
    ...
    try:
        ...
        for user in notify_users:
            ...
            message["To"] = user
            message["From"] = "drive-transfer-service@themicrolab.joonix.net"
            ...
            send_message = (
                service.users()
                .messages()
                .send(userId="drive-transfer-service@themicrolab.joonix.net", body=create_message)
                .execute()
            )
